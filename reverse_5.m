function [th1,th5]=reverse_5(pose,px,py,pz)
...
a = pose(1:3,3);
% 根据矩阵对应关系，反变换求th1
th1 = atan2((py-25*a(2)),(px-25*a(1)));
% th1 = atan2(a(2),a(1))+pi;
th5 = atan2(n(1)*sin(th1)-n(2)*cos(th1),o(1)*sin(th1)-o(2)*cos(th1));
% th5 = atan2(sin(th1)*n(1)-cos(th1)*n(2),cos(th1)*a(2)-sin(th1)*a(1));
% th2 = atan2(sin(th5)*n(3)-cos(th5)*a(3),sin(th5)*cos(th1)*n(1)+sin(th5)*sin(th1)*n(2)-cos(th5)*cos(th1)*a(1)-cos(th5)*sin(th1)*a(2))-pi/2;
% 
% C2 = cos(th2);
% C1 = cos(th1);
% S1 = sin(th1);
